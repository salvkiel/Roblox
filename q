...
local function makeImmortal(character)
	...
	-- Set health jadi sangat besar dan kunci agar tidak berkurang
	humanoid.MaxHealth = math.huge
	humanoid.Health = math.huge

	-- Hapus semua script atau efek damage bawaan
	...
	-- Jika mati, segera hidupkan ulang tanpa respawn
...
-- Pas karakter muncul, langsung aktifkan kebal
...
-- Tombol RESPAWN (diubah agar tetap kebal)
...
-- Teleport List
local teleportList = {
	{name = "PUNCAK", pos = Vector3.new(306.211, 1262.616, 86.109)},
}
