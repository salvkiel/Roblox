...
-- ====== TELEPORT LIST ======
local teleportList = {
	{name = "Teleport Pos 1", pos = Vector3.new(361.612, 79.37, 207.832), delay = 10},
	{name = "Teleport Pos 2", pos = Vector3.new(431, 124.798, 274), delay = 25},
	{name = "Teleport Pos 3", pos = Vector3.new(765.971, 41.229, 297.01), delay = 13},
	{name = "Teleport Pos 4", pos = Vector3.new(792.198, 168.381, 266.515), delay = 6},
	{name = "Teleport Pos 5", pos = Vector3.new(563.3, 434.69, 371.2), delay = 21},
	{name = "Teleport Pos 6", pos = Vector3.new(246.507, 422.713, 386.992), delay = 30},
	{name = "Teleport Pos 7", pos = Vector3.new(34.106, 433.849, 589.7), delay = 21},
	{name = "Teleport Pos 8", pos = Vector3.new(210.527, 498.659, 222.636), delay = 11},
	{name = "Teleport Pos 9", pos = Vector3.new(159, 567.754, 137.5), delay = 29},
	{name = "Teleport Pos 10", pos = Vector3.new(153.8, 818.99, 271.2), delay = 30},
	{name = "Teleport Pos 11", pos = Vector3.new(-237.755, 977.229, 653.546), delay = 8},
	{name = "Teleport Pos 12", pos = Vector3.new(-373.265, 1165.287, 874.169), delay = 5},
	{name = "Teleport Pos 13", pos = Vector3.new(-509.065, 1159.037, 874.269), delay = 5},
	{name = "Teleport Pos 14", pos = Vector3.new(-731.055, 1224.723, 778.609), delay = 12},
	{name = "Teleport Pos 15", pos = Vector3.new(-997.665, 1404.85, 1012.4), delay = 12},
	{name = "Teleport Pos 16", pos = Vector3.new(-1142.917, 1601.023, 679.097), delay = 12},
	{name = "Teleport Pos 17", pos = Vector3.new(-1103.776, 1724.4, 666.1), delay = 12},
	{name = "Teleport Pos 18", pos = Vector3.new(-1034.8, 1724.587, 1035.8), delay = 12},
	{name = "Teleport Pos 19", pos = Vector3.new(-711.055, 1899.144, 1040.314), delay = 12},
	{name = "Teleport Pos 20", pos = Vector3.new(-503.8, 1910.308, 729.1), delay = 12},
	{name = "Teleport Pos 21", pos = Vector3.new(-1120.-66, 2080.198, 674.734), delay = 12},
	{name = "PUNCAK", pos = Vector3.new(-960.35, 3141.5, 511.8), delay = 3},
	{name = "BASECAMP", pos = Vector3.new(775.3, 50.4, 651.25), delay = 5},
}

-- ====== FUNKSI PENDUKUNG ======
local teleporting = false
local lastManualIndex = 1 -- simpan posisi teleport manual terakhir
...
local function makeTeleportButton(name, pos, idx)
	...
	tpButton.MouseButton1Click:Connect(function()
		...
		if safeTeleportTo(pos) then
			lastManualIndex = idx -- simpan indeks teleport terakhir manual
...
-- ====== AUTO FARM LOOP ======
local function respawnPlayer(callback)
...
local function autoFarmLoop()
	while teleporting do
		...
		-- Mulai dari posisi terakhir manual
		...
		if teleporting then
			respawnPlayer(function()
				safeTeleportTo(teleportList[#teleportList].pos)
			end)
			lastManualIndex = 1
		end
	end
