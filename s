...
local teleportList = {
    ...
    {name = "Teleport Pos 3", pos = Vector3.new(-234.331, 401.994, 4034.662), delay = 10},
    {name = "Teleport Pos 4", pos = Vector3.new(-260.452, 339.807, 4382.458), delay = 5},
    {name = "Teleport Pos 5", pos = Vector3.new(-350.004, 331.38, 4563.691), delay = 25},
    {name = "Teleport Pos 6", pos = Vector3.new(-863.008, 228.044, 5330.454), delay = 25},
    {name = "Teleport Pos 7", pos = Vector3.new(-1381.331, 504.732, 6360.716), delay = 20},
    {name = "Teleport Pos 8", pos = Vector3.new(-1521.099, 537.663, 6747.521), delay = 10},
    {name = "Teleport Pos 9", pos = Vector3.new(-1489.38, 546.493, 7075.592), delay = 50},
    {name = "Teleport Pos 10", pos = Vector3.new(-892.735, 481.662, 8299.804), delay = 25},
    {name = "Teleport Pos 11", pos = Vector3.new(-497.311, 608.767, 8792.895), delay = 10},
