...
local teleportList = {
    ...
    {name = "Teleport Pos 9", pos = Vector3.new(-1489.38, 546.493, 7075.592), delay = 52},
    {name = "Teleport Pos 10", pos = Vector3.new(-892.735, 481.662, 8299.804), delay = 27},
    {name = "Teleport Pos 11", pos = Vector3.new(-497.311, 608.767, 8792.895), delay = 12},
    {name = "Teleport Pos 12", pos = Vector3.new(-303.358, 611.169, 8947.14), delay = 12},
